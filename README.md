...
Welcome to the Introduction to NLP repository!
...
```
conda create --name nlp_session_env python=3.11
conda activate nlp_session_env
...
python -m ipykernel install --user --name=nlp_session_env
```
Then when in the notebook, remember to set the kernel to "**nlp_session_env**".
